...
untangleGame.isIntersect = function(line1, line2)
{
	...
	//resolve the interseption point at (x, y)
	var x = (b2*c1 - b1*c2)/d;
	var y = (a1*c2 - a2*c1)/d;
	//Check if the interception point is on both line segments
	if ((untangleGame.isInBetween(line1.startPoint.x, x, line1.endPoint.x) || 
		untangleGame.isInBetween(line1.startPoint.y, y, line1.endPoint.y)) && 
	...
	//by default the line is not intersected
	return false;
}
